...
public class BluetoothChatService {
    public static final String serverHost = "192.168.43.42";
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (mState == STATE_CONNECTED) {
                ...
                try {
                    InputStreamReader clientStreamReader = new InputStreamReader(mmInStream);
                    ...
                    if (SDK_INT > 8) {
                        ...
                        while (character != -1 && character != flusher) {
                            proxyStreamWriter.write(character);
                            character = clientStreamReader.read();
                        }

                        if (character == flusher)
                            proxyStreamWriter.write(flusher);

                        proxyStreamWriter.flush();
                        android.util.Log.i("x", "Data sended! ");
                        Thread.sleep(200);
                    ...
                    Log.i("x", "Data received: " + new String(outputStream.toByteArray(), StandardCharsets.UTF_8));
